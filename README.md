...
## Step 7
- We need to import the contract abi and the contract addresses and Optimism RPC from the `.env` file. Navigate to the `pages/axelar.js` file and update the file with the following code:
```
//...
...
- Navigate to the `pages/axelar.js` file and update the file with the following code:
```
//...
...
- Inside the `pages/axelar.js` file and update the file with the following code:
```
//...
